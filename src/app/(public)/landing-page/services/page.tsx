...
export function Services() {
    return (
        <div
            id="services"
            className="bg-crayola-50/40 px-6 md:px-12 lg:px-40 py-24 flex flex-col items-start"
        >
            <SectionHeading title="Nossos serviços" />

            <div className="w-full max-w-[31rem]">
                <p className="text-2xl lg:text-3xl font-semibold mt-8 text-night-600">
                    É por isso que a Enlightish nasceu: para que o idioma jamais
                    seja um obstáculo entre a sua voz e as pessoas.
                </p>
                        ...
                        list={
                            <ul className="flex flex-col gap-2">
                                <li className="flex gap-3 text-sm items-center">
                                    {' '}
                                    <Check /> Vocabulário missionário e bíblico
                                </li>
                                <li className="flex gap-3 text-sm items-center">
                                    {' '}
                                ...
                                <li className="flex gap-3 text-sm items-center">
                                    {' '}
                                    <Check /> Material feito para a realidade do
                                    campo
                                </li>
                            </ul>
                        }
                    ...
                    <Card
                        ...
                        list={
                            <ul className="flex flex-col gap-2">
                                ...
                                <li className="flex gap-3 text-sm items-center">
                                    {' '}
                                    <Check /> Você aprende com a experiência dos
                                    outros
                                </li>
                            </ul>
                        }
                    ...
                    <Card
                        ...
                        list={
                            <ul className="flex flex-col gap-2">
                                ...
                                <li className="flex gap-3 text-sm items-center">
                                    {' '}
                                    <Check /> Um ritmo diferente de aprendizado
                                </li>
                            </ul>
                        }
                    />
