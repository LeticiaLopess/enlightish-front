...
export function About() {
    return (
        <div
            id="about"
            className="px-6 md:px-12 lg:px-40 py-24 flex flex-col lg:gap-20 lg:flex-row items-start justify-between"
        >
            <section className="flex flex-col w-full lg:w-1/2">
                ...
                <div>
                    <p className="text-2xl lg:text-3xl font-semibold mt-8 text-night-600">
                        A <span className="underline">única</span> escola online
                        que une o ensino de inglês à missão cristã para
                        transformar sua vida e alcançar outras!
                    </p>
                    <p className="text-md lg:text-lg mt-6 text-neutral-600 !leading-6">
                        ...
                        exclusivo no contexto missionário, você terá a confiança
                        para evangelizar e pregar a Palavra em qualquer lugar.
                    </p>
                </div>
                ...
                <div className="mt-20">
                    ...
                    <ul className="flex flex-col gap-3">
                        ...
                        <li className="flex gap-3 text-sm md:text-lg">
                            {' '}
                            <Check /> Material didático de acordo com seu nível
                            e objetivo
                        </li>
                        <li className="flex gap-3 text-sm md:text-lg">
                            {' '}
