...
export function Feedback() {
    return (
        <div id="feedback" className="bg-neutral-900 px-6 md:px-12 lg:px-40 py-24 flex flex-col items-start">
            <SectionHeading title="Feedback de alunos" />
            <div className="w-full flex flex-col lg:flex-row justify-between mt-8">
                <p className="text-[28px] lg:text-[34px] font-semibold leading-[1.2] text-day-50 max-w-[40rem] mb-2">Confira o que nossos alunos dizem sobre a escola e como o inglês tem impactado a vida deles!</p>
                <p className="text-night-100 max-w-[30rem]">Histórias reais, transformações incríveis: Descubra como o inglês abriu portas e realizou sonhos de nossos alunos.</p>
            </div>
